...
RIGHT_PANE_CMD="cd \"$ROOT_DIR\" && ./scripts/codex-task.sh $QUOTED_PROMPT; TASK_EXIT=\$?; echo; echo \"[tmux-codex-workflow] task exit code: \$TASK_EXIT\"; echo \"[tmux-codex-workflow] pane left open for result review\"; exec bash"
