...
export interface CliArgs {
  mode: CliMode;
  command?: "session-list" | "session-continue" | "checkpoint-list" | "checkpoint-show";
  prompt?: string;
  sessionId?: string;
  checkpointId?: string;
  inputFile?: string;
  ...
  trace: boolean;
  showHelp: boolean;
  helpTopic?: "main" | "repl" | "session-list" | "session-continue" | "checkpoint-list" | "checkpoint-show";
}
